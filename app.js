...
const supabase = ready ? createClient(cfg.SUPABASE_URL, cfg.SUPABASE_PUBLISHABLE_KEY, { auth: { persistSession: true, autoRefreshToken: true, detectSessionInUrl: true } }) : null;
...
let profileList = [];
const KIDS_SHOWS = new Set(["Static Shock","The Proud Family","The Proud Family Movie","Just Jordan"]); const KIDS_PLUS_SHOWS = new Set(["Just Jordan"]);

const VIDEO_BASE = "https://uatv-video.urbananimetv10.workers.dev";
const videoUrl = key => `${VIDEO_BASE}/${key.split("/").map(encodeURIComponent).join("/")}`;
...
const SHOWS = {
  ...
  "The PJs": {
    ...
    seasons:[
      {number:1,episodes:Array.from({length:15},(_,i)=>({number:i+1,title:`Episode ${i+1}`,description:"Premium episode",video:i===0?`${VIDEO_BASE}/The%20PJs/The.PJs.s01e01.480p.mp4`:i===1?`${VIDEO_BASE}/The%20PJs/The.PJs.s01e02.480p.mp4`:i===2?`${VIDEO_BASE}/The%20PJs/The.PJs.s01e03.480p.mp4`:i===3?`${videoUrl("The PJs/The.PJs.s01e04.480p.mp4")}`:i===4?`${videoUrl("The PJs/The.PJs.s01e05.480p.mp4")}`:i===5?`${videoUrl("The PJs/The.PJs.s01e06.480p.mp4")}`:i===6?`${videoUrl("The PJs/The.PJs.s01e07.480p.mp4")}`:i===7?`${videoUrl("The PJs/The.PJs.s01e08.480p.mp4")}`:i===8?`${videoUrl("The PJs/The.PJs.s01e09.480p.mp4")}`:i===9?`${videoUrl("The PJs/The.PJs.s01e10.480p.mp4")}`:i===10?`${videoUrl("The PJs/The.PJs.s01e11.480p.mp4")}`:i===11?`${videoUrl("The PJs/The.PJs.s01e12.480p.mp4")}`:i===12?`${videoUrl("The PJs/The.PJs.s01e13.480p.mp4")}`:i===13?`${videoUrl("The PJs/The.PJs.s01e14.480p.mp4")}`:null}))},
  ...
  "Static Shock": {
    ...
    seasons:[{number:1,episodes:[
      {number:1,title:"Episode 1",description:"Static Shock Season 1 Episode 1.",video:`${videoUrl("Static Shock/Static.Shock.S01E01.1080p.HMAX.WEB-DL.DD2.0.H.264-AlfaHD.mkv.mp4")}`},
      {number:2,title:"Episode 2",description:"Static Shock Season 1 Episode 2.",video:`${videoUrl("Static Shock/Static.Shock.S01E02.1080p.HMAX.WEB-DL.DD2.0.H.264-AlfaHD.mkv.mp4")}`},
    ]}]
  },
  "The Proud Family": {
    type:"series", premium:true, live:true, channel:true, kid:true,
    ...
    seasons:[{number:1,episodes:[
      {number:1,title:"Bring It On",description:"The Proud Family Season 1 Episode 1.",video:`${VIDEO_BASE}/The%20Proud%20Family/The.Proud.Family.S01E01.Bring.It.On.360P.mp4`},
      {number:2,title:"Strike",description:"The Proud Family Season 1 Episode 2.",video:`${VIDEO_BASE}/The%20Proud%20Family/The.Proud.Family.S01E02.Strike.360P.mp4`},
      {number:3,title:"Rumors",description:"The Proud Family Season 1 Episode 3.",video:`${VIDEO_BASE}/The%20Proud%20Family/The.Proud.Family.S01E03.Rumors.360P.mp4`},
      {number:4,title:"Tiger Whisperer",description:"The Proud Family Season 1 Episode 4.",video:`${VIDEO_BASE}/The%20Proud%20Family/The.Proud.Family.S01E04.Tiger.Whisperer.360P.mp4`},
      {number:5,title:"EZ Jackster",description:"The Proud Family Season 1 Episode 5.",video:`${VIDEO_BASE}/The%20Proud%20Family/The.Proud.Family.S01E05.EZ.Jackster.360P.mp4`},
      {number:6,title:"Spelling Bee",description:"The Proud Family Season 1 Episode 6.",video:`https://uatv-video.urbananimetv10.workers.dev/The%20Proud%20Family/The.Proud.Family.S01E06.Spelling.Bee.360P.mp4`},
      {number:7,title:"She's Got Gme",description:"The Proud Family Season 1 Episode 7.",video:`${videoUrl("The Proud Family/The.Proud.Family.S01E07.She's.Got.Gme.360P.mp4")}`},
      {number:8,title:"Forbidden Date",description:"The Proud Family Season 1 Episode 8.",video:`${videoUrl("The Proud Family/The.Proud.Family.S01E08.Forbidden.Date.360P.mp4")}`}
    ]}]
  },
  "The Proud Family Movie": {
    type:"movie", premium:true, live:false, channel:false, kid:true,
    description:"The Proud Family Movie — Penny Proud and her family take on a big-screen adventure together.",
    image:"proud-family-movie-thumbnail.jpg",
    seasons:[{number:1,episodes:[{number:1,title:"The Proud Family Movie",description:"The Proud Family Movie (2005).",video:`${videoUrl("The Proud Family/The.Proud.Family.Movie.2005.1080p.AMZN.WEB-DL.DDP5.1.H.264-NTb.mkv.mp4")}]}]
  },
  "Afro Samurai: Resurrection": {
    type:"movie", premium:true, live:false, channel:false,
    description:"Afro Samurai: Resurrection — Afro returns for another cinematic battle of revenge and survival.",
    image:"afro-samurai-movie-thumbnail.jpg",
    seasons:[{number:1,episodes:[{number:1,title:"Afro Samurai: Resurrection",description:"Afro Samurai: Resurrection (2009).",video:`${videoUrl("Afro Samurai/Afro.Samurai.Resurrection.2009.1080p.BluRay.H264.AAC-RARBG.mp4")}]}]
  },
  "Black Dynamite": {
    type:"series", premium:true, live:true, channel:true,
    ...
    {number:2,episodes:[
      {number:1,title:"Episode 1",description:"Black Dynamite Season 2 Episode 1.",video:`${videoUrl("Black Dynamite/Black.Dynamite.S02E01.1080p.HMAX.WEB-DL.DD5.1.H.264-PlayWEB.mkv.mp4")}`},
      {number:2,title:"Episode 2",description:"Black Dynamite Season 2 Episode 2.",video:`${videoUrl("Black Dynamite/Black.Dynamite.S02E02.1080p.HMAX.WEB-DL.DD5.1.H.264-PlayWEB.mkv.mp4")}`},
      {number:3,title:"Episode 3",description:"Black Dynamite Season 2 Episode 3.",video:`${videoUrl("Black Dynamite/Black.Dynamite.S02E03.1080p.HMAX.WEB-DL.DD5.1.H.264-PlayWEB.mkv.mp4")}`},
      {number:4,title:"Episode 4",description:"Black Dynamite Season 2 Episode 4.",video:`${videoUrl("Black Dynamite/Black.Dynamite.S02E04.1080p.HMAX.WEB-DL.DD5.1.H.264-PlayWEB.mkv.mp4")}`},
      {number:5,title:"Episode 5",description:"Black Dynamite Season 2 Episode 5.",video:`${videoUrl("Black Dynamite/Black.Dynamite.S02E05.1080p.HMAX.WEB-DL.DD5.1.H.264-PlayWEB.mkv.mp4")}`},
      {number:6,title:"Episode 6",description:"Black Dynamite Season 2 Episode 6.",video:`${videoUrl("Black Dynamite/Black.Dynamite.S02E06.1080p.HMAX.WEB-DL.DD5.1.H.264-PlayWEB.mkv.mp4")}`}
    ]}
  },
  "The Cleveland Show": {
    type:"series", premium:true, live:true, channel:true,
    ...
    seasons:[{number:1,episodes:[
      {number:1,title:"Pilot",description:"The Cleveland Show Season 1 Episode 1.",video:`${VIDEO_BASE}/The%20Cleveland%20Show/The.Cleveland.Show.S01E01.Pilot.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE%5BUTR%5D.mkv.mp4`},
      {number:2,title:"Da Daggone Daddy-Daughter Dinner Dance",description:"The Cleveland Show Season 1 Episode 2.",video:`${VIDEO_BASE}/The%20Cleveland%20Show/The.Cleveland.Show.S01E02.Da.Daggone.Daddy-Daughter.Dinner.Dance.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE%5BUTR%5D.mkv.mp4`},
      {number:3,title:"The One About Friends",description:"The Cleveland Show Season 1 Episode 3.",video:`${VIDEO_BASE}/The%20Cleveland%20Show/The.Cleveland.Show.S01E03.The.One.About.Friends.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE%5BUTR%5D.mkv.mp4`},
      {number:4,title:"Birth of a Salesman",description:"The Cleveland Show Season 1 Episode 4.",video:`${VIDEO_BASE}/The%20Cleveland%20Show/The.Cleveland.Show.S01E04.Birth.of.a.Salesman.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE%5BUTR%5D.mkv.mp4`},
      {number:5,title:"Cleveland Jr.'s Cherry Bomb",description:"The Cleveland Show Season 1 Episode 5.",video:`${VIDEO_BASE}/The%20Cleveland%20Show/The.Cleveland.Show.S01E05.Cleveland.Jr.'s.Cherry.Bomb.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE%5BUTR%5D.mkv.mp4`},
      {number:6,title:"Ladies' Night",description:"The Cleveland Show Season 1 Episode 6.",video:`${VIDEO_BASE}/The%20Cleveland%20Show/The.Cleveland.Show.S01E06.Ladies'.Night.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE%5BUTR%5D.mkv.mp4`},
      {number:7,title:"A Brown Thanksgiving",description:"The Cleveland Show Season 1 Episode 7.",video:`${videoUrl("The Cleveland Show/The.Cleveland.Show.S01E07.A.Brown.Thanksgiving.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE[UTR].mkv.mp4")}`},
      {number:8,title:"From Bed to Worse",description:"The Cleveland Show Season 1 Episode 8.",video:`${videoUrl("The Cleveland Show/The.Cleveland.Show.S01E08.From.Bed.to.Worse.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE[UTR].mkv.mp4")}`},
      {number:9,title:"A Cleveland Brown Christmas",description:"The Cleveland Show Season 1 Episode 9.",video:`${videoUrl("The Cleveland Show/The.Cleveland.Show.S01E09.A.Cleveland.Brown.Christmas.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE[UTR].mkv.mp4")}`},
      {number:10,title:"Field of Streams",description:"The Cleveland Show Season 1 Episode 10.",video:`${videoUrl("The Cleveland Show/The.Cleveland.Show.S01E10.Field.of.Streams.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE[UTR].mkv.mp4")}`},
      {number:11,title:"Love Rollercoaster",description:"The Cleveland Show Season 1 Episode 11.",video:`${videoUrl("The Cleveland Show/The.Cleveland.Show.S01E11.Love.Rollercoaster.1080p.WEB-DL.x265.10bit.AAC.5.1-ImE[UTR].mkv.mp4")}`}
    ]}]
  },
  "Just Jordan": {
    type:"series", premium:true, live:true, channel:true, kid:true,
    ...
    seasons:[{number:1,episodes:[
      ...
      {number:13,title:"Episode 13",description:"Just Jordan Season 1 Episode 13.",video:`https://uatv-video.urbananimetv10.workers.dev/Just%20Jordan/Just.Jordan.S01E13.360p.mp4`},
    ]},
    {number:2,episodes:[
      {number:1,title:"Episode 1",description:"Just Jordan Season 2 Episode 1.",video:`https://uatv-video.urbananimetv10.workers.dev/Just%20Jordan/Just.Jordan.S02E01.360p.mp4`},
      {number:2,title:"Episode 2",description:"Just Jordan Season 2 Episode 2.",video:`https://uatv-video.urbananimetv10.workers.dev/Just%20Jordan/Just.Jordan.S02E02.360p.mp4`},
      {number:3,title:"Episode 3",description:"Just Jordan Season 2 Episode 3.",video:`https://uatv-video.urbananimetv10.workers.dev/Just%20Jordan/Just.Jordan.S02E03.360p.mp4`},
      {number:4,title:"Episode 4",description:"Just Jordan Season 2 Episode 4.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E04.360p.mp4")}`},
      {number:5,title:"Episode 5",description:"Just Jordan Season 2 Episode 5.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E05.360p.mp4")}`},
      {number:6,title:"Episode 6",description:"Just Jordan Season 2 Episode 6.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E06.360p.mp4")}`},
      {number:7,title:"Episode 7",description:"Just Jordan Season 2 Episode 7.",video:`https://uatv-video.urbananimetv10.workers.dev/Just%20Jordan/Just.Jordan.S02E07.360p.mp4`},
      {number:8,title:"Episode 8",description:"Just Jordan Season 2 Episode 8.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E08.360p.mp4")}`},
      {number:9,title:"Episode 9",description:"Just Jordan Season 2 Episode 9.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E09.360p.mp4")}`},
      {number:10,title:"Episode 10",description:"Just Jordan Season 2 Episode 10.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E10.360p.mp4")}`},
      {number:11,title:"Episode 11",description:"Just Jordan Season 2 Episode 11.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E11.360p.mp4")}`},
      {number:12,title:"Episode 12",description:"Just Jordan Season 2 Episode 12.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E12.360p.mp4")}`},
      {number:13,title:"Episode 13",description:"Just Jordan Season 2 Episode 13.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E13.360p.mp4")}`},
      {number:14,title:"Episode 14",description:"Just Jordan Season 2 Episode 14.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E14.360p.mp4")}`},
      {number:15,title:"Episode 15",description:"Just Jordan Season 2 Episode 15.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E15.360p.mp4")}`},
      {number:16,title:"Episode 16",description:"Just Jordan Season 2 Episode 16.",video:`${videoUrl("Just Jordan/Just.Jordan.S02E16.360p.mp4")}`}
    ]}]
  },
  "Aqua Teen Hunger Force": {
    ...
    seasons:[{number:1,episodes:[
      ...
      {number:2,title:"Escape from Leprechaupolis",description:"Aqua Teen Hunger Force Season 1 Episode 2.",video:`${VIDEO_BASE}/Aqua%20Teen%20Hunger%20Force/Aqua.Teen.Hunger.Force.S01E02.Escape.from.Leprechaupolis.720p.mkv.mp4`},
      {number:3,title:"Bus of the Undead",description:"Aqua Teen Hunger Force Season 1 Episode 3.",video:`${VIDEO_BASE}/Aqua%20Teen%20Hunger%20Force/Aqua.Teen.Hunger.Force.S01E03.Bus.of.the.Undead.720p.mkv.mp4`},
      {number:4,title:"Mayhem of the Mooninites",description:"Aqua Teen Hunger Force Season 1 Episode 4.",video:`${VIDEO_BASE}/Aqua%20Teen%20Hunger%20Force/Aqua.Teen.Hunger.Force.S01E04.Mayhem.of.the.Mooninites.720p.mkv.mp4`},
      {number:5,title:"Balloonenstein",description:"Aqua Teen Hunger Force Season 1 Episode 5.",video:`${VIDEO_BASE}/Aqua%20Teen%20Hunger%20Force/Aqua.Teen.Hunger.Force.S01E05.Balloonenstein.720p.mkv.mp4`},
      {number:6,title:"Space Conflict from Beyond Pluto",description:"Aqua Teen Hunger Force Season 1 Episode 6.",video:`${VIDEO_BASE}/Aqua%20Teen%20Hunger%20Force/Aqua.Teen.Hunger.Force.S01E06.Space.Conflict.from.Beyond.Pluto.720p.mkv.mp4`},
      {number:7,title:"01' Drippy",description:"Aqua Teen Hunger Force Season 1 Episode 7.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E07.Ol'.Drippy.720p.mkv.mp4")}`},
      {number:8,title:"Revenge of the Mooninites",description:"Aqua Teen Hunger Force Season 1 Episode 8.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E08.Revenge.of.the.Mooninites.720p.mkv.mp4")}`},
      {number:9,title:"MC Pee Pants",description:"Aqua Teen Hunger Force Season 1 Episode 9.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E09.MC.Pee.Pants.720p.mkv.mp4")}`},
      {number:10,title:"Circus",description:"Aqua Teen Hunger Force Season 1 Episode 10.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E10.Circus.720p.mkv.mp4")}`},
      {number:11,title:"Dumber Days",description:"Aqua Teen Hunger Force Season 1 Episode 11.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E11.Dumber.Days.720p.mkv.mp4")}`},
      {number:12,title:"Love Mummy",description:"Aqua Teen Hunger Force Season 1 Episode 12.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E12.Love.Mummy.720p.mkv.mp4")}`},
      {number:13,title:"Dumber Dolls",description:"Aqua Teen Hunger Force Season 1 Episode 13.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E13.Dumber.Dolls.720p.mkv.mp4")}`},
      {number:14,title:"Interfection",description:"Aqua Teen Hunger Force Season 1 Episode 14.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E14.Interfection.720p.mkv.mp4")}`},
      {number:15,title:"Bad Replicant",description:"Aqua Teen Hunger Force Season 1 Episode 15.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E15.Bad.Replicant.720p.mkv.mp4")}`},
      {number:16,title:"PDA",description:"Aqua Teen Hunger Force Season 1 Episode 16.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E16.PDA.720p.mkv.mp4")}`},
      {number:17,title:"Mail-Order Bride",description:"Aqua Teen Hunger Force Season 1 Episode 17.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E17.Mail-Order.Bride.720p.mkv.mp4")}`},
      {number:18,title:"Cybernetic Ghost of Christmas",description:"Aqua Teen Hunger Force Season 1 Episode 18.",video:`${videoUrl("Aqua Teen Hunger Force/Aqua.Teen.Hunger.Force.S01E18.Cybernetic.Ghost.of.Christmas.720p.mkv.mp4")}`}
    ]}]
  }
};
...
function ensureUATVHomeScreenIcon(){
  if(!document.querySelector('link[rel="apple-touch-icon"]')){
    const link=document.createElement("link"); link.rel="apple-touch-icon"; link.href="apple-touch-icon.png"; document.head.appendChild(link);
  }
...
function openDetails(title){
  ...
  select.dataset.showTitle=title;
  select.innerHTML=show.seasons.length
    ? show.seasons.map(s=>`<option value="${s.number}">${show.type==="movie"?"Movie":`Season ${s.number}`}</option>`).join("")
    : `<option value="1">${show.type==="movie"?"Movie":"Season 1"}</option>`;
...
function renderEpisodes(title,seasonNumber){
  ...
  if(!show) return;
  const modal=$("#modal");
  if(modal?.dataset.title && modal.dataset.title!==title) return;
  const requestedSeason=Number(seasonNumber)||1;
  const season=show.seasons.find(s=>s.number===requestedSeason)||show.seasons[0];
  const list=$("#episodeList");
  if(!list)return;
  list.dataset.showTitle=title;
  list.dataset.season=String(season?.number||requestedSeason);
  const seasonSelect=$("#seasonSelect");
  if(seasonSelect){
    seasonSelect.dataset.showTitle=title;
    if(season) seasonSelect.value=String(season.number);
  }
  ...
  list.innerHTML=season.episodes.map(ep=>{
    ...
    return `<article class="episode-card ${locked?"episode-locked":""}">
      ...
      <button class="episode-play" ${playable?'':'disabled'} data-episode-title="${safe(title)}" data-episode-number="${ep.number}" data-episode-season="${season.number}" aria-label="${playable?'Play':'Locked'} episode ${ep.number}">
        ...
        <span class="episode-action-label">${show.type==="movie" && playable?"WATCH NOW":state}</span>
      </button>
    </article>`;
  }).join("");
...
function isKidsAllowed(title){return KIDS_SHOWS.has(title);}
...
function renderAdultCatalog(){
  ...
  const titles=Object.keys(SHOWS).filter(title=>SHOWS[title]?.type!=="movie");
  row.innerHTML=titles.map(title=>{const show=SHOWS[title];return `<article class="wide-card" data-title="${safe(title)}" data-type="series"><div class="art addon-card-art"><img src="${show.image}" alt="${safe(title)}"></div><h3>${safe(title)}</h3><p>${show.premium?"Premium":"UrbanAnimeTv"}${show.live?" • Live TV":" • Series"}</p></article>`;}).join("");
  let movieSection=$("#adultMoviesSection");
  if(!movieSection){movieSection=document.createElement("section");movieSection.id="adultMoviesSection";movieSection.className="catalog-subsection";row.parentElement?.after(movieSection);}
  const movies=Object.keys(SHOWS).filter(title=>SHOWS[title]?.type==="movie");
  movieSection.innerHTML=movies.length?`<div class="section-heading"><div><span class="section-kicker">MOVIES</span><h2>Movies</h2></div></div><div class="poster-row">${movies.map(title=>{const show=SHOWS[title];return `<article class="wide-card movie-card" data-title="${safe(title)}" data-type="movie"><div class="art addon-card-art"><img src="${show.image}" alt="${safe(title)}"></div><h3>${safe(title)}</h3><p>${show.premium?"Premium":"UrbanAnimeTv"} • Movie</p></article>`;}).join("")}</div>`:"";
  $$("#adultMoviesSection .movie-card").forEach(card=>card.onclick=e=>{e.stopPropagation();openDetails(card.dataset.title);});
}
...
function ensureKidsPlusStyles(){
  ...
  style.textContent=`
    #kidsPlusCarousel{position:relative;margin:24px 0 30px;border-radius:18px;overflow:hidden;background:#090909;border:1px solid rgba(255,255,255,.10);min-height:430px;box-shadow:0 18px 50px rgba(0,0,0,.35)}
    #kidsPlusCarousel .kids-plus-track{position:relative;min-height:430px}
    #kidsPlusCarousel .kids-plus-hero-slide{display:none;position:relative;min-height:430px;overflow:hidden}
    #kidsPlusCarousel .kids-plus-hero-slide.active{display:flex}
    #kidsPlusCarousel .kids-plus-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:block}
    #kidsPlusCarousel .kids-plus-overlay{position:absolute;inset:0;background:linear-gradient(90deg,rgba(0,0,0,.90) 0%,rgba(0,0,0,.72) 38%,rgba(0,0,0,.20) 75%,rgba(0,0,0,.45) 100%),linear-gradient(0deg,rgba(0,0,0,.72) 0%,transparent 55%)}
    #kidsPlusCarousel .kids-plus-copy{position:relative;z-index:2;align-self:flex-end;max-width:620px;padding:0 34px 58px}
    #kidsPlusCarousel .kids-plus-kicker{display:inline-block;font-size:12px;font-weight:800;letter-spacing:2px;color:#fff;opacity:.88;margin-bottom:8px}
    #kidsPlusCarousel .kids-plus-copy h2{font-size:clamp(34px,5vw,62px);line-height:.98;margin:0 0 12px;font-weight:900;color:#fff;text-transform:uppercase}
    #kidsPlusCarousel .kids-plus-copy p{font-size:15px;line-height:1.5;color:rgba(255,255,255,.82);max-width:560px;margin:0 0 20px}
    #kidsPlusCarousel .kids-plus-actions{display:flex;gap:10px;flex-wrap:wrap}
    #kidsPlusCarousel .kids-plus-actions .watch-btn,#kidsPlusCarousel .kids-plus-actions .list-btn{min-height:44px}
    #kidsPlusCarousel .kids-plus-arrows{position:absolute;right:18px;top:18px;z-index:4;display:flex;gap:8px}
    #kidsPlusCarousel .kids-plus-arrows button{width:42px;height:42px;border-radius:50%;border:1px solid rgba(255,255,255,.25);background:rgba(0,0,0,.52);color:#fff;font-size:28px;line-height:1;cursor:pointer}
    #kidsPlusCarousel .kids-plus-dots{position:absolute;z-index:4;left:34px;bottom:20px;display:flex;gap:8px}
    #kidsPlusCarousel .kids-plus-dot{width:22px;height:4px;border:0;border-radius:4px;background:rgba(255,255,255,.35);padding:0;cursor:pointer}
    #kidsPlusCarousel .kids-plus-dot.active{background:#fff}
    @media(max-width:650px){
      #kidsPlusCarousel,#kidsPlusCarousel .kids-plus-track,#kidsPlusCarousel .kids-plus-hero-slide{min-height:360px}
      #kidsPlusCarousel .kids-plus-overlay{background:linear-gradient(90deg,rgba(0,0,0,.82) 0%,rgba(0,0,0,.48) 100%),linear-gradient(0deg,rgba(0,0,0,.82) 0%,transparent 60%)}
      #kidsPlusCarousel .kids-plus-copy{padding:0 20px 52px;max-width:92%}
      #kidsPlusCarousel .kids-plus-copy h2{font-size:34px}
      #kidsPlusCarousel .kids-plus-copy p{font-size:13px;margin-bottom:14px}
      #kidsPlusCarousel .kids-plus-arrows{right:12px;top:12px}
      #kidsPlusCarousel .kids-plus-arrows button{width:38px;height:38px;font-size:24px}
      #kidsPlusCarousel .kids-plus-dots{left:20px;bottom:18px}
    }`;
...
function renderKidsPlusCarousel(){
  ...
  if(!wrap){
    ...
    wrap.className="kids-plus-hero";
    wrap.innerHTML=`
      <div class="kids-plus-track" id="kidsPlusTrack"></div>
      <div class="kids-plus-arrows">
        <button type="button" id="kidsPlusPrev" aria-label="Previous Kids+ show">‹</button>
        <button type="button" id="kidsPlusNext" aria-label="Next Kids+ show">›</button>
      </div>
      <div class="kids-plus-dots" id="kidsPlusDots"></div>`;
    const featured=kidsSection.querySelector("#kidsHomeFeatured");
    if(featured && featured.parentElement) featured.parentElement.insertBefore(wrap,featured);
    else kidsSection.prepend(wrap);
  }

  const titles=[...KIDS_PLUS_SHOWS].filter(t=>SHOWS[t]);
  const track=$("#kidsPlusTrack");
  const dots=$("#kidsPlusDots");
  if(!track || !dots || !titles.length){wrap.classList.add("hidden");return;}
  wrap.classList.remove("hidden");
  ...
  const render=()=>{
    track.innerHTML=titles.map((title,i)=>{
      const show=SHOWS[title];
      const episodeCount=(show.seasons||[]).reduce((total,season)=>total+(season.episodes||[]).length,0);
      const watchLabel=show.live?"Watch Live":"Watch Now";
      return `<article class="kids-plus-hero-slide ${i===index?"active":""}" data-title="${safe(title)}">
        <img class="kids-plus-bg" src="${show.image}" alt="${safe(title)}">
        <div class="kids-plus-overlay"></div>
        <div class="kids-plus-copy">
          <span class="kids-plus-kicker">UATV KIDS+</span>
          <h2>${safe(title)}</h2>
          <p>${safe(show.description)}${episodeCount?` • ${episodeCount} episodes`:""}</p>
          <div class="kids-plus-actions">
            <button type="button" class="watch-btn kids-plus-watch" data-kids-hero-title="${safe(title)}" data-kids-hero-live="${show.live?"true":"false"}"><span class="play-symbol" aria-hidden="true"></span><span>${watchLabel}</span></button>
            <button type="button" class="list-btn kids-plus-library" data-kids-hero-list="${safe(title)}">＋ <span>In Library</span></button>
          </div>
        </div>
      </article>`;
    }).join("");

    dots.innerHTML=titles.map((title,i)=>`<button type="button" class="kids-plus-dot ${i===index?"active":""}" data-kids-dot="${i}" aria-label="Show ${i+1}: ${safe(title)}"></button>`).join("");
    wrap.dataset.index=String(index);

    $$(".kids-plus-watch").forEach(b=>b.onclick=e=>{
      e.stopPropagation();
      const title=b.dataset.kidsHeroTitle;
      if(b.dataset.kidsHeroLive==="true"){showSection("live-tv");return;}
      openDetails(title);
    });
    $$(".kids-plus-library").forEach(b=>b.onclick=e=>{e.stopPropagation();toggleList(b.dataset.kidsHeroList);});
    $$(".kids-plus-hero-slide").forEach(slide=>slide.onclick=e=>{
      if(e.target.closest("button"))return;
      openDetails(slide.dataset.title);
    });
    $$(".kids-plus-dot").forEach(d=>d.onclick=e=>{e.stopPropagation();index=Number(d.dataset.kidsDot);render();restart();});
  };
  ...
  const restart=()=>{
    ...
    if(titles.length>1)wrap._uatvKidsPlusTimer=setInterval(()=>move(1),7000);
  };

  $("#kidsPlusPrev")?.replaceWith($("#kidsPlusPrev").cloneNode(true));
  $("#kidsPlusNext")?.replaceWith($("#kidsPlusNext").cloneNode(true));
  $("#kidsPlusPrev")?.addEventListener("click",e=>{e.stopPropagation();move(-1);restart();});
  $("#kidsPlusNext")?.addEventListener("click",e=>{e.stopPropagation();move(1);restart();});
...
function renderKidsSection(){
  const kidTitles=Object.keys(SHOWS).filter(t=>isKidsAllowed(t)&&SHOWS[t]?.type==="series");
  const featured=$("#kidsHomeFeatured");
  const proud=SHOWS["The Proud Family"];
  if(featured && proud){
    const proudEpisodeCount=(proud.seasons||[]).reduce((total,season)=>total+(season.episodes||[]).length,0);
    featured.innerHTML=`<article class="kids-feature-card" data-title="The Proud Family"><div class="kids-feature-art"><img src="${proud.image}" alt="The Proud Family"></div><div class="kids-feature-copy"><span class="kids-kicker">FEATURED KIDS SHOW</span><h2>THE PROUD FAMILY</h2><p>Season 1 • ${proudEpisodeCount} episodes • Family Comedy</p><div class="kids-feature-actions"><button type="button" class="watch-btn" id="kidsFeaturedWatch">▶ Watch Now</button><button type="button" class="list-btn" id="kidsFeaturedList">＋ My List</button></div></div></article>`;
    $("#kidsFeaturedWatch")?.addEventListener("click",e=>{e.stopPropagation();openDetails("The Proud Family");});
    $("#kidsFeaturedList")?.addEventListener("click",e=>{e.stopPropagation();toggleList("The Proud Family");});
  }
...
function renderKidsSeries(){
  ...
  const titles=Object.keys(SHOWS).filter(t=>isKidsAllowed(t)&&SHOWS[t]?.type==="series");
...
function ensureKidsMovieStyles(){
  if($("#kidsMovieStyles"))return;
  const style=document.createElement("style");style.id="kidsMovieStyles";
  style.textContent=`#kidsMoviesSection{margin:28px 0 36px}#kidsMoviesSection .kids-movie-heading{margin-bottom:14px}#kidsMoviesSection .kids-movie-heading h2{margin:0;font-size:28px}#kidsMoviesSection .kids-movie-heading p{margin:5px 0 0;color:#999}#kidsMoviesSection .kids-movie-row{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:16px}#kidsMoviesSection .kids-movie-card{cursor:pointer}#kidsMoviesSection .kids-movie-card .art{aspect-ratio:16/9;overflow:hidden;border-radius:14px}#kidsMoviesSection .kids-movie-card img{width:100%;height:100%;object-fit:cover;display:block}#kidsMoviesSection .kids-movie-card h3{margin:10px 0 4px}#kidsMoviesSection .kids-movie-card p{margin:0;color:#999;font-size:13px}`;
  document.head.appendChild(style);
}
function renderKidsMovies(){
  ensureKidsMovieStyles();
  const kidsSection=$("#kids-section");if(!kidsSection)return;
  let box=$("#kidsMoviesSection");
  if(!box){box=document.createElement("section");box.id="kidsMoviesSection";box.className="kids-movies-section";const series=kidsSection.querySelector("#kidsSeriesContent");(series?.parentElement||kidsSection).appendChild(box);}
  const movies=Object.keys(SHOWS).filter(t=>isKidsAllowed(t)&&SHOWS[t]?.type==="movie");
  box.innerHTML=movies.length?`<div class="kids-movie-heading"><h2>Movies</h2><p>UATV Kids movies</p></div><div class="kids-movie-row">${movies.map(t=>`<article class="library-card kids-movie-card" data-title="${safe(t)}"><div class="art"><img src="${SHOWS[t].image}" alt="${safe(t)}"></div><h3>${safe(t)}</h3><p>Movie • Watch Now</p></article>`).join("")}</div>`:"";
  $$(".kids-movie-card").forEach(card=>card.onclick=e=>{e.stopPropagation();openDetails(card.dataset.title);});
}
...
async function init(){
  ...
  $("#seasonSelect").onchange=e=>{
    ...
    const modal=$("#modal");
    const title=modal?.dataset.title || select.dataset.showTitle || activeTitle;
    if(!title || !SHOWS[title]) return;
    select.dataset.showTitle=title;
    renderEpisodes(title,Number(select.value)||1);
  };
