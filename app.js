...
const SHOWS = {
  ...
  "The Cleveland Show": {
    ...
    seasons:[{number:1,episodes:[
      {number:1,title:"Pilot",description:"The Cleveland Show Season 1 Episode 1.",video:`${VIDEO_BASE}/The%20Cleveland%20Brown%20Show/The.Cleveland.Show.S01E01.Pilot.1080p.WEB-DL.x265.10bit.AAC.5.1-1ME%5BUTR%5D.mkv.mp4`}
    ]}]
  },
  "Just Jordan": {
    type:"series", premium:true, live:true, channel:true,
