...
const SHOWS = {
  ...
  "Just Jordan": {
    type:"series", premium:true, live:true, channel:true,
    description:"Just Jordan — a comedy series about Jordan and his family, friends and life in the city.",
    ...
    seasons:[{
      ...
      episodes:Array.from({length:15},(_,i)=>({
        ...
        video:i===0?`${VIDEO_BASE}/Just%20Jordan/Just.Jordan.S01E01.360p.mp4`:null
      }))
    }]
  },
