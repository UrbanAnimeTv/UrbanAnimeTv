...
const SHOWS = {
  ...
  "The PJs": {
    ...
    seasons:[
      {number:1,episodes:Array.from({length:15},(_,i)=>({number:i+1,title:`Episode ${i+1}`,description:"Premium episode",video:i===0?`${VIDEO_BASE}/The%20PJs/The.PJs.s01e01.480p.mp4`:i===1?`${VIDEO_BASE}/The%20PJs/The.PJs.s01e02.480p.mp4`:null}))},
