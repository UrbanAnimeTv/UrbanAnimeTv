...
let profileList = [];
const KIDS_SHOWS = new Set(["Static Shock","The Proud Family","The Proud Family Movie"]); const KIDS_PLUS_SHOWS = new Set(["Just Jordan"]);
...
async function init(){
  ...
  $("#seasonSelect").onchange=e=>{
    e.stopPropagation();
    const title=e.currentTarget.dataset.showTitle || activeTitle;
    if(title && SHOWS[title]) renderEpisodes(title,Number(e.currentTarget.value)||1);
  };
